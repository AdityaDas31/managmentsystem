        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-8 mx-auto">
                    ...
                    <p class="copyright text-muted text-center">© Copyright <script>document.write(new Date().getFullYear())</script> | Web Design by <a href="https://www.linkedin.com/in/aditya-das-513883222">Aditya Das</a></p>
                </div>
            </div>
        </div>
    </footer>
