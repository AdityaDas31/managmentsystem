    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="bg-white shadow">
                ...
                ?>
                        <form method="POST" action="Tupdate1.php" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="<?php echo $row['Name'] ?>" id="disabledTextInput" name="tname" class="form-control" placeholder="Teacher Name">
                            </div>
                            <div class="mb-3">
                                <label for="disabledTextInput" class="form-label">Teacher ID</label>
                                <input type="text" value="<?php echo $row['TeacherID'] ?>" id="disabledTextInput" name="tid" class="form-control" placeholder="Teacher ID">
                            </div>
                            <div class="mb-3">
                                <label for="disabledTextInput" class="form-label">Department</label>
                                <input type="text" value="<?php echo $row['Department'] ?>" id="disabledTextInput" name="tdep" class="form-control" placeholder="Department">
                            </div>
                            <div class="mb-3">
                                <label for="disabledTextInput" class="form-label">Image</label>
                                <input type="file" id="disabledTextInput" name="timage" class="form-control" placeholder="Image"><br>
